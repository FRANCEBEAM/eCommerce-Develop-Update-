...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/changed.css">
...
<div class="main-container">
  <div class="form-container">
    <div class="head-content">
        <h2 class="mb-5">Let's started</h2>
        <p class="mb-0 text-success">Your account is all setup.</p>
    </div>

    <form method="POST">
        <button type="submit" class="btn btn-primary btn-lg btn-block btnVerify" name="verify_email">Sign in</button>
    </form>
  </div>
</div>
